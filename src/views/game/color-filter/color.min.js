...
export default (() => {
    ...
    (function() {
        ...
        s.reduce = s.foldl = s.inject = function(H, C, K, J) {
            ...
            if (null == H && (H = []),
            p && H.reduce === p) {
                return J && (C = s.bind(C, J)),
                G ? H.reduce(C, K) : H.reduce(C);
            }
            if (e(H, function(L, P, Q) {
                G ? K = C.call(J, K, L, P, Q) : (K = L,
                G = !0);
            }),
            !G) {
        ...
        s.reduceRight = s.foldr = function(G, K, J, H) {
            ...
            if (null == G && (G = []),
            S && G.reduceRight === S) {
                return H && (K = s.bind(K, H)),
                P ? G.reduceRight(K, J) : G.reduceRight(K);
            }
            var L = G.length;
            if (L !== +L) {
                var C = s.keys(G);
        ...
        s.sample = function(H, G, C) {
            return null == G || C ? (H.length !== +H.length && (H = s.values(H)),
            H[s.random(H.length - 1)]) : s.shuffle(H).slice(0, Math.max(0, G));
        }
        ;
        var k = function(C) {
        ...
        s.sortBy = function(H, G, C) {
            return G = k(G),
            s.pluck(s.map(H, function(J, K, L) {
                return {
                    value: J,
                    index: K,
        ...
        s.uniq = s.unique = function(G, K, J, H) {
            ...
            return e(P, function(Q, U) {
                (K ? U && C[C.length - 1] === Q : s.contains(C, Q)) || (C.push(Q),
                L.push(G[U]));
            }),
            L;
        }
        ...
        s.throttle = function(P, C, U) {
            ...
            return function() {
                ...
                Q = V,
                L = P.apply(K, G),
                K = G = null) : H || U.trailing === !1 || (H = setTimeout(J, W)),
                L;
            }
            ;
        }
        ...
        var F = function(Q, C, V, K) {
            ...
            Q instanceof s && (Q = Q._wrapped),
            C instanceof s && (C = C._wrapped);
            var G = u.call(Q);
            if (G != u.call(C)) {
                return !1;
            }
        ...
        s.random = function(C, G) {
            return null == G && (G = C,
            C = 0),
            C + Math.floor(Math.random() * (G - C + 1));
        }
        ,
        ...
        s.mixin(s),
        e(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(C) {
            var G = l[C];
            s.prototype[C] = function() {
                var H = this._wrapped;
                return G.apply(H, arguments),
                "shift" != C && "splice" != C || 0 !== H.length || delete H[0],
                b.call(this, H);
            }
            ;
        }),
        ...
        var b = $("#box")
          ...
          , a = {
            ...
            initEvent: function() {
                ...
                c.pause.on(d, _.bind(this.pause, this)),
                c.resume.on(d, _.bind(this.resume, this)),
                c.start.on(d, _.bind(this.start, this)),
                c.back.on(d, _.bind(this.back, this)),
                c.share.on(d, _.bind(this.share, this));
            },
            start: function() {
            ...
            pause: function() {
                ...
                c.d_pause.show(),
                c.dialog.show(),
                AdObj = '<a href="{url}"  class="btn btn-restart" style="text-decoration: none;">{title}</a>';
                ADs = [];
            ...
            gameOver: function() {
                ...
                this.lastLv = this.lv,
                this.lastGameTxt = e.txt,
                this.lastGamePercent = e.percent,
                c.d_share.hide().find("h3").text(this.lastGameTxt),
                c.d_share.hide().find("h2").text(this.lv + "关"),
                c.d_content.hide(),
                c.d_gameover.show().find("h3").text(this.lastGameTxt),
                c.d_gameover.show().find("h2").text(this.lv + "关"),
                b.find("span").fadeOut(1000, function() {
                    c.dialog.fadeIn();
                }),
                this._pause = !0,
                this.reset();
                ...
                // }, 1000);
                var f = Game.lastLv > 0 ? "我闯过" + (Game.lastLv) + "关，我的视力超过" + Game.lastGameTxt + "！不服來战！" : "保护眼睛，16关以下不要再玩手机了！";
                //DouyaGame.resetShareText(f);
            },
            reset: function() {
        ...
        var d = $("#box")
          ...
          , c = {
            ...
            render: function(h, i) {
                ...
                this.d = 15 * Math.max(9 - j, 1),
                this.d = i > 20 ? 10 : this.d,
                this.d = i > 40 ? 8 : this.d,
                this.d = i > 50 ? 5 : this.d;
                var m = Math.floor(Math.random() * h * h)
                  , f = this.getColor(255 - this.d)
                  , g = this.getLvColor(f[0]);
                d.find(e).css("background-color", f[1]).data("type", "b"),
                d.find(e).eq(m).css("background-color", g[1]).data("type", "a");
            },
            getColor: function(g) {
